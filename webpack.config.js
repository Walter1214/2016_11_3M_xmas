...
var config = {
    ...
    devServer: {
        proxy: {
            '/customapi': {
                // target: 'http://3m-xmas2016.azurewebsites.net/',
                target: 'http://3M-event.medialand.com.tw/',
                changeOrigin: true
            }
        },
    ...
    module: {
        ...
        loaders: [{
            ...
            },
            {
                test: /\.js$/,
                loader: 'babel',
                include: [path.resolve('src/js'), path.resolve('src/lib')],
                query: {
            ...
            {
                test: /\.(png|jpg|gif)$/, //url-loader, 小於 2 K 的圖片會變 base64, 其他就搬到 dist/asset/img/
                loader: 'url-loader?limit=1024&name=asset/[path][name].[ext]',
                include: path.resolve('src/img'),
                exclude: /node_modules/
            },
            {
            ...
            {
                test: /\.html$/,
                loader: 'file?name=[name].html!html',
                include: path.resolve('src/html')
            },
            {
                test: /\.jade$/,
